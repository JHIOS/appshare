        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div id="gg"></div>
                    <div class="alert alert-success" role="alert">用友金融提供了四种储存途径。<br><strong>七牛:</strong>
                    ...
                    <br><strong>远程:</strong>
                    如果你有其他空闲服务器，你可以在其上面搭建用友金融文件存储服务，将文件存储在远程服务器，不消耗本地服务器流量、存储空间。
                    远程服务器搭建教程请<a href="https://appstore.yonyou.com/">点击这里</a>
                    ...
                    流量用多少，存储免多少。又拍云实现存储减免优惠，以 CDN 流量使用量 1:1 的减免存储空间使用费用。助力用户大幅节省存储成本，让创业更高效。[教程请点击这里]<a href="https://appstore.yonyou.com/portal/article/index/cid/3/id/1.html">点击这里</a>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
  ...
  <div class="col-sm-6 col-md-4">
    ...
    <div class="thumbnail">
      ...
      <div class="caption">
        ...
        <p>使用用友金融提供的服务端脚本，你可以将文件存放在远程服务器上。搭建教程：<a href="https://appstore.yonyou.com">https://appstore.yonyou.com</a></p>
            ...
            <div class="row">
                <div class="col-lg-2" align="right">
                 ...
                 <input type="text" name="p_server" class="form-control">
                    ...
                    <div class="col-lg-3" align="right">
                <div class="sm" align="left">远程服务器接口URL，比如PHP接口：https://appstore.yonyou.com/fileServer.php
            ...
            <div class="row">
                <div class="col-lg-2" align="right">
                 ...
                 <input type="text" name="kjurl" class="form-control">
                    ...
                    <div class="col-lg-3" align="right">
              <div class="sm" align="left">外链的根URL，即一个上传文件后生成的外链除去文件名剩余部分。比如，你设置的储存目录为/data目录，远程服务器域名为appstore.yonyou.com/sites/，则你的外链URL为https://appstore.yonyou.com/data/,<strong>只需填写主体部分，开头无需加“http://”，结尾无需加“/”</strong></div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-2" align="right">
                 ...
                 <input type="text" name="kjurl" class="form-control">
                    ...
                    <div class="col-lg-3" align="right">
              <div class="sm" align="left">外链的根URL，即一个上传文件后生成的外链除去文件名剩余部分。比如，你设置的储存目录为/data目录，你用友金融站点域名为appstore.yonyou.com/sites/，则你的外链URL为https://appstore.yonyou.com/data/,<strong>只需填写主体部分，开头无需加“http://”，结尾无需加“/”</strong></div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-2" align="right">
                 ...
                 <input type="text"  value="uploads"name="p_dir"class="form-control">
                    ...
                    <div class="col-lg-3" align="right">
                <div class="sm" align="left">文件存放目录，相对于用友金融主目录的位置。<strong>开始与结尾都无需加"/"</strong>.比如，将文件存放在与首页同级目录的子目录中，只需填写data/dir2</div>
                    </div>
                <div style="height:10px;"></div>             
            </div>
              <div class="row">
