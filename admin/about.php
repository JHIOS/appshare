...
<body>
  ...
  <h1><span class="fa fa-cloud"></span> 关于 用友金融</h1>
  <p>程序版本：2.4 - A,&nbsp;&nbsp;版本代号：14A;&nbsp;&nbsp;主题支持版本：14A</p>
  <p>作者博客：<a href="https://appstore.yonyou.com" target="new">树洞</a>;
  ...
  <p>感谢您使用 用友金融</p>
  <p>P.S.用友金融的作者是个苦逼程序员，你可以<a href="https://appstore.yonyou.com/about" target="new">点击这里</a>捐助我以支持用友金融发展！</p>
  <p><strong>使用协议：</strong>
1.你可以在保留版权链接的情况下以非商业目的使用用友金融；<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
2.你可以自由修改本程序，但禁止以商业目的出售、专卖原程序、二次修改程序；<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
3.对于不遵守以上协议的，用友金融开发者有权停止对其的服务支持并追究法律责任。
  </p>
</div>
...
function check(){
	$("#jc").attr("disabled","true");
		$("#jc").html("检查中...");
$.getJSON("https://appstore.yonyou.com/api/check.php?v=<?php echo $version[1] ?>&callback=?",
   function(data){
var ge=data;
	if(ge[0]=="bad"){ 
