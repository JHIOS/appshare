...
<head>
    ...
    <title><?php echo $title ?> - 用友金融管理中心</title>
  ...
  <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">用友金融管理面板</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                       ...
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
								 ...
								 <li>
                                    <a href="ipalist.php">IPA包列表</a>
                                </li>
								 <li>
                                    <a href="ipa.php">设置IPA包</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                       ...
                       <li>
                            ...
                            <li>
                                ...
                                <li>
                                    <a href="https://appstore.yonyou.com/" target="new">官方网站</a>
                                </li>
