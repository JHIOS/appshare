...
$stmt = $con->prepare("INSERT INTO  `$sqlname`.`sd_file` (`ming` ,`key1` ,`uploadip` ,`uploadtime` ,`cishuo` ,`upuser` ,`policyid`,`filename`,`name`)VALUES (?, '$rand', '$ip', '$dd', '0' , '$uploadUser', '$policyId', '$filename', '$name');");
