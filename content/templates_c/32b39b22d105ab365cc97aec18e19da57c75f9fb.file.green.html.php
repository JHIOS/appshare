<?php /* Smarty version Smarty-3.1.18, created on 2017-01-11 01:43:48
         compiled from "./content/themes/material/green.html" */ ?>
<?php /*%%SmartyHeaderCode:473516762586323bd438dd6-15842083%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '32b39b22d105ab365cc97aec18e19da57c75f9fb' => 
    array (
      0 => './content/themes/material/green.html',
      1 => 1484098997,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '473516762586323bd438dd6-15842083',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_586323bd5a2c36_40277665',
  'variables' => 
  array (
    'filename' => 0,
    'zzurl' => 0,
...
<?php if ($_valid && !is_callable('content_586323bd5a2c36_40277665')) {function content_586323bd5a2c36_40277665($_smarty_tpl) {?><!DOCTYPE html>
...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        ...
        <meta name="keywords" content="用友金融 pgyer  企业签名 iOS Android 安卓苹果应用测试托管 免费上传内测分发安装 开放SDK CDN">
    ...
    <link rel="stylesheet" href="https://static.pgyer.com/static-20161125/assets/css/appView.css">
    <style>
    body {
        color:#969b9d;
   size:14px;
    ...
    #header {
        background:url('<?php echo $_smarty_tpl->tpl_vars['zzurl']->value;?>
content/themes/material/img/top_bg.png') no-repeat scroll center;
        height:300px;
    }
    #appicon-bg {
...
<div class="container content"> 	
    ...
    <div class="view row">
                <div class="span12 margin-bottom-30" id="appicon-bg" style="text-align:center;">
                        <a href="javascript:void(0);" onclick="javascript:install();"><img src="<?php echo $_smarty_tpl->tpl_vars['imgurl']->value;?>
" class="appicon" onerror="javascript:this.src='../plist/default-icon.png';" /></a>
                        <div>
            </div>
        </div>
                <div class="span12" style="text-align:center;padding-top:10px;">
            <h2 style="color:#333;size:24px;margin-bottom: -5px;"><?php echo $_smarty_tpl->tpl_vars['filename']->value;?>
</h2>
        </div>

        <div class="span12 gray-text" style="text-align:center;">
            <ul class="breadcrumb">
                            <li>版本：<?php echo $_smarty_tpl->tpl_vars['ver']->value;?>
</li>
                <li>大小：<?php echo $_smarty_tpl->tpl_vars['size']->value;?>
 MB</li>
                            <li>更新于：<?php echo $_smarty_tpl->tpl_vars['time']->value;?>
</li>
            </ul>
        </div>
        ...
        <div class="span12 gray-text" style="text-align:center;">
            <img src="https://pan.baidu.com/share/qrcode?w=260&h=260&url=<?php echo $_smarty_tpl->tpl_vars['zzurl']->value;?>
f.php?k=<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
" style="width:156px; height:156px;" />
            <p style="padding-top:10px;color:#969b9d;">或者用手机扫描下面的二维码安装</p>
        </div>
    </div>
    ...
    <div id="" class="view row" style="margin-top:30px;">    
            ...
            <div class="loading"></div>
                        <a href="javascript:void(0);" onclick="javascript:install_loading();" id="down_load"  class="btn-u btn-u-lg"><i class="fa fa-download"></i> 点击安装</a>
                       </div>
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1=='ipa') {?>
                            <span class="label label-info"><i aria-hidden="true" class="fa fa-apple" style="font-size:16px;"></i> 适用于iOS设备</span>
                                        <span class="label label-danger">企业版</span>
            <?php } else { ?>
                <span class="label label-success"><i aria-hidden="true" class="fa fa-android" style="font-size:16px;"></i> 适用于Android设备</span>
            <span class="label label-danger">企业版</span>
            <?php }?>
                    </div>
...
<script type="text/javascript" src="https://static.pgyer.com/static-20161125/assets/plugins/jquery-1.10.2.min.js"></script>
<script type="text/javascript" src="https://static.pgyer.com/static-20161125/assets/plugins/jquery-migrate-1.2.1.min.js"></script>
<script type="text/javascript" src="https://static.pgyer.com/static-20161125/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
<script type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['zzurl']->value;?>
content/themes/material/pgyer/js/app.js"></script>

<script src="https://static.pgyer.com/static-20161125/assets/plugins/sky-forms/version-2.0.1/js/jquery.validate.min.js"></script>
<!--[if lt IE 9]>
<script src="https://static.pgyer.com/static-20161125/assets/plugins/respond.js"></script>
<![endif]-->    
<!-- JS Page Level -->
<script type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['zzurl']->value;?>
content/themes/material/pgyer/js/appView.js"></script>

<script type="text/javascript">
var aType = 'ios',
    aKey = '<?php echo $_smarty_tpl->tpl_vars['skey']->value;?>
',
    submiting = '请稍后...',
    submitText = '立即进入',
    isMobileRequest = '',
    ...
    isIOS = 0,
    plisturl='<?php echo $_smarty_tpl->tpl_vars['codeurl']->value;?>
'
