...
if (leixing == "png" || leixing == "jpg" || leixing == "gif" || leixing == "jpeg" || leixing == "bmp" || leixing == "PNG" || leixing == "JPG" || leixing == "GIF" || leixing == "JPEG" || leixing == "BMP"){
					...
					window.location.href = 'views/ipa.php?filename='+filename+'&name='+name+'.ipa&uid='+key1;
					}else if (leixing == "apk"||leixing == "APK"){


                            ApkParser.apkinfo(up.files[0],function (manifest) {
                                var package = manifest['package'];
                                var icon = manifest['application']['icon'];
                                var label = manifest['application']['label'];
                                var appname = manifest['application']['description'];
                                window.location.href = 'views/apk.php?filename='+filename+'&name='+name+'.ipa&uid='+key1+'&package='+package+'&icon='+icon+'&label='+label+'&appname='+appname;
